# Este archivo introduce crew de soporte completa con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("crew de soporte completa")

# Resumen final: crew de soporte completa es una pieza concreta de CrewAI que se combina despues con el resto del agente.
