# Este archivo introduce crew de investigacion con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("crew de investigacion")

# Resumen final: crew de investigacion es una pieza concreta de CrewAI que se combina despues con el resto del agente.
