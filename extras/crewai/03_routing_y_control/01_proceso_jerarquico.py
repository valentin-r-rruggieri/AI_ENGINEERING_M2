# Este archivo introduce proceso jerarquico con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("proceso jerarquico")

# Resumen final: proceso jerarquico es una pieza concreta de CrewAI que se combina despues con el resto del agente.
