# Este archivo introduce proceso secuencial con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("proceso secuencial")

# Resumen final: proceso secuencial es una pieza concreta de CrewAI que se combina despues con el resto del agente.
