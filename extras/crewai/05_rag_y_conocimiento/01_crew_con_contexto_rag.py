# Este archivo introduce crew con contexto RAG con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("crew con contexto RAG")

# Resumen final: crew con contexto RAG es una pieza concreta de CrewAI que se combina despues con el resto del agente.
