# Este archivo introduce knowledge sources para RAG con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("knowledge sources para RAG")

# Resumen final: knowledge sources para RAG es una pieza concreta de CrewAI que se combina despues con el resto del agente.
