# Este archivo introduce observabilidad de una Crew con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("observabilidad de una Crew")

# Resumen final: observabilidad de una Crew es una pieza concreta de CrewAI que se combina despues con el resto del agente.
