# Este archivo introduce Flow orientado a eventos con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("Flow orientado a eventos")

# Resumen final: Flow orientado a eventos es una pieza concreta de CrewAI que se combina despues con el resto del agente.
