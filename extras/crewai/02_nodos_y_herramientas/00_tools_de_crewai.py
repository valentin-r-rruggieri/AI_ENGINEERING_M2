# Este archivo introduce tools de CrewAI con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("tools de CrewAI")

# Resumen final: tools de CrewAI es una pieza concreta de CrewAI que se combina despues con el resto del agente.
