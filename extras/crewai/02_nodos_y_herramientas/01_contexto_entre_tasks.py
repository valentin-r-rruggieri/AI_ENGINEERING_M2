# Este archivo introduce contexto entre tasks con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("contexto entre tasks")

# Resumen final: contexto entre tasks es una pieza concreta de CrewAI que se combina despues con el resto del agente.
