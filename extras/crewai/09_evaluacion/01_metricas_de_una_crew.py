# Este archivo introduce metricas de una Crew con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("metricas de una Crew")

# Resumen final: metricas de una Crew es una pieza concreta de CrewAI que se combina despues con el resto del agente.
