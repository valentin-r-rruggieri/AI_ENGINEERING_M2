# Este archivo introduce pruebas de tasks con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("pruebas de tasks")

# Resumen final: pruebas de tasks es una pieza concreta de CrewAI que se combina despues con el resto del agente.
