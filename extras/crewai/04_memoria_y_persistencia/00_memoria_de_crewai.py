# Este archivo introduce memoria de CrewAI con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("memoria de CrewAI")

# Resumen final: memoria de CrewAI es una pieza concreta de CrewAI que se combina despues con el resto del agente.
