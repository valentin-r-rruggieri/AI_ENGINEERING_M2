# Este archivo introduce estado de un Flow con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("estado de un Flow")

# Resumen final: estado de un Flow es una pieza concreta de CrewAI que se combina despues con el resto del agente.
