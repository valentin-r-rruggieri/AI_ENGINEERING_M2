# Este archivo introduce delegacion entre agentes con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("delegacion entre agentes")

# Resumen final: delegacion entre agentes es una pieza concreta de CrewAI que se combina despues con el resto del agente.
