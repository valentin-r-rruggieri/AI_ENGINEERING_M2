# Este archivo introduce Crew de agentes con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("Crew de agentes")

# Resumen final: Crew de agentes es una pieza concreta de CrewAI que se combina despues con el resto del agente.
