# Este archivo introduce salidas estructuradas con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
# Resumen final: salidas estructuradas es una pieza concreta de CrewAI que se combina despues con el resto del agente.
