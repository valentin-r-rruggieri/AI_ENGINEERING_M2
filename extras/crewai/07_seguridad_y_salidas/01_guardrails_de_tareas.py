# Este archivo introduce guardrails de tareas con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("guardrails de tareas")

# Resumen final: guardrails de tareas es una pieza concreta de CrewAI que se combina despues con el resto del agente.
