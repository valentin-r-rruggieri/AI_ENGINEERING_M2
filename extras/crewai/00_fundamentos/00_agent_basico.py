# Este archivo introduce Agent basico con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("Agent basico")

# Resumen final: Agent basico es una pieza concreta de CrewAI que se combina despues con el resto del agente.
