# Este archivo introduce Task basica con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("Task basica")

# Resumen final: Task basica es una pieza concreta de CrewAI que se combina despues con el resto del agente.
