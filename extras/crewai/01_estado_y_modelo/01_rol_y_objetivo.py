# Este archivo introduce rol y objetivo con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("rol y objetivo")

# Resumen final: rol y objetivo es una pieza concreta de CrewAI que se combina despues con el resto del agente.
