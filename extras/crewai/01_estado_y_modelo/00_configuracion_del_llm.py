# Este archivo introduce configuracion del LLM con CrewAI. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("configuracion del LLM")

# Resumen final: configuracion del LLM es una pieza concreta de CrewAI que se combina despues con el resto del agente.
