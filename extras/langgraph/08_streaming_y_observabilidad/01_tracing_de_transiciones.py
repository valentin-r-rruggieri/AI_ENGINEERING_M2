# Este archivo introduce tracing de transiciones con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("tracing de transiciones")

# Resumen final: tracing de transiciones es una pieza concreta de LangGraph que se combina despues con el resto del agente.
