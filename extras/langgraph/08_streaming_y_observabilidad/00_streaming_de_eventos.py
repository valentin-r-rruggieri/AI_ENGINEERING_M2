# Este archivo introduce streaming de eventos con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("streaming de eventos")

# Resumen final: streaming de eventos es una pieza concreta de LangGraph que se combina despues con el resto del agente.
