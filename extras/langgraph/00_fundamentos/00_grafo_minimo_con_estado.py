# Este archivo introduce grafo minimo con estado con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("grafo minimo con estado")

# Resumen final: grafo minimo con estado es una pieza concreta de LangGraph que se combina despues con el resto del agente.
