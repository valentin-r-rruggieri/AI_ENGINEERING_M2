# Este archivo introduce estado compartido entre nodos con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("estado compartido entre nodos")

# Resumen final: estado compartido entre nodos es una pieza concreta de LangGraph que se combina despues con el resto del agente.
