# Este archivo introduce edges entre nodos con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("edges entre nodos")

# Resumen final: edges entre nodos es una pieza concreta de LangGraph que se combina despues con el resto del agente.
