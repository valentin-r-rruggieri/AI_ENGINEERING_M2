# Este archivo introduce routing condicional con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("routing condicional")

# Resumen final: routing condicional es una pieza concreta de LangGraph que se combina despues con el resto del agente.
