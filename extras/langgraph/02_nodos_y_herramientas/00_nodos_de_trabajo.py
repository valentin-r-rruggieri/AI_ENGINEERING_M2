# Este archivo introduce nodos de trabajo con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("nodos de trabajo")

# Resumen final: nodos de trabajo es una pieza concreta de LangGraph que se combina despues con el resto del agente.
