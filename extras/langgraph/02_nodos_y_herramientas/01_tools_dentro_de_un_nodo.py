# Este archivo introduce tools dentro de un nodo con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("tools dentro de un nodo")

# Resumen final: tools dentro de un nodo es una pieza concreta de LangGraph que se combina despues con el resto del agente.
