# Este archivo introduce memoria de una conversacion con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("memoria de una conversacion")

# Resumen final: memoria de una conversacion es una pieza concreta de LangGraph que se combina despues con el resto del agente.
