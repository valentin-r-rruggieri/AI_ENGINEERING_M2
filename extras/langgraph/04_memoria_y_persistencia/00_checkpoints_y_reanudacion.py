# Este archivo introduce checkpoints y reanudacion con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("checkpoints y reanudacion")

# Resumen final: checkpoints y reanudacion es una pieza concreta de LangGraph que se combina despues con el resto del agente.
