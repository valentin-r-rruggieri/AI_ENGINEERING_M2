# Este archivo introduce supervisor multiagente con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("supervisor multiagente")

# Resumen final: supervisor multiagente es una pieza concreta de LangGraph que se combina despues con el resto del agente.
