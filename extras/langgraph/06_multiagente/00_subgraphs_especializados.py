# Este archivo introduce subgraphs especializados con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("subgraphs especializados")

# Resumen final: subgraphs especializados es una pieza concreta de LangGraph que se combina despues con el resto del agente.
