# Este archivo introduce agente local completo con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("agente local completo")

# Resumen final: agente local completo es una pieza concreta de LangGraph que se combina despues con el resto del agente.
