# Este archivo introduce actualizacion de estado con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("actualizacion de estado")

# Resumen final: actualizacion de estado es una pieza concreta de LangGraph que se combina despues con el resto del agente.
