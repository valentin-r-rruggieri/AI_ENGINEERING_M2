# Este archivo introduce schema de estado con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("schema de estado")

# Resumen final: schema de estado es una pieza concreta de LangGraph que se combina despues con el resto del agente.
