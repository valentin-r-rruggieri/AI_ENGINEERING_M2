# Este archivo introduce human in the loop con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("human in the loop")

# Resumen final: human in the loop es una pieza concreta de LangGraph que se combina despues con el resto del agente.
