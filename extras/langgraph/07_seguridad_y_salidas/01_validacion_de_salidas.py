# Este archivo introduce validacion de salidas con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("validacion de salidas")

# Resumen final: validacion de salidas es una pieza concreta de LangGraph que se combina despues con el resto del agente.
