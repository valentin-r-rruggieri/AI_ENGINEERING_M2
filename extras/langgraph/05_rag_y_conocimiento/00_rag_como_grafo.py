# Este archivo introduce RAG como grafo con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("RAG como grafo")

# Resumen final: RAG como grafo es una pieza concreta de LangGraph que se combina despues con el resto del agente.
