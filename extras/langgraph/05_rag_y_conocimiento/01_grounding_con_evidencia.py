# Este archivo introduce grounding con evidencia con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("grounding con evidencia")

# Resumen final: grounding con evidencia es una pieza concreta de LangGraph que se combina despues con el resto del agente.
