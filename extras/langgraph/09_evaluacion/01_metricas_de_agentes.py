# Este archivo introduce metricas de agentes con LangGraph. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("metricas de agentes")

# Resumen final: metricas de agentes es una pieza concreta de LangGraph que se combina despues con el resto del agente.
