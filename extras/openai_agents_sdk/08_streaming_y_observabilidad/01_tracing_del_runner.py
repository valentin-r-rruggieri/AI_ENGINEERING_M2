# Este archivo introduce tracing del Runner con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("tracing del Runner")

# Resumen final: tracing del Runner es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
