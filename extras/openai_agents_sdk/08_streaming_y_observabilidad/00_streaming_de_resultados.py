# Este archivo introduce streaming de resultados con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("streaming de resultados")

# Resumen final: streaming de resultados es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
