# Este archivo introduce agente orquestador con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("agente orquestador")

# Resumen final: agente orquestador es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
