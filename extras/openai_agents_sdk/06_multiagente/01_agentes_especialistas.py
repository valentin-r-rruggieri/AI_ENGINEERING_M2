# Este archivo introduce agentes especialistas con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("agentes especialistas")

# Resumen final: agentes especialistas es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
