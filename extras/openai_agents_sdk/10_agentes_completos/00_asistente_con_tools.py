# Este archivo introduce asistente con tools con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("asistente con tools")

# Resumen final: asistente con tools es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
