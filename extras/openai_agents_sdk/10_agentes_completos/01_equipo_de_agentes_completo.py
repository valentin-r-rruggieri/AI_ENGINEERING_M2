# Este archivo introduce equipo de agentes completo con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("equipo de agentes completo")

# Resumen final: equipo de agentes completo es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
