# Este archivo introduce guardrails de entrada y salida con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("guardrails de entrada y salida")

# Resumen final: guardrails de entrada y salida es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
