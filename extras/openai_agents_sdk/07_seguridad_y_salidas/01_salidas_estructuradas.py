# Este archivo introduce salidas estructuradas con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("salidas estructuradas")

# Resumen final: salidas estructuradas es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
