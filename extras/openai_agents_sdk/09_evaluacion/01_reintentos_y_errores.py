# Este archivo introduce reintentos y errores con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("reintentos y errores")

# Resumen final: reintentos y errores es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
