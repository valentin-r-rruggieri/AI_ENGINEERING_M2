# Este archivo introduce evaluacion de agentes con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("evaluacion de agentes")

# Resumen final: evaluacion de agentes es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
