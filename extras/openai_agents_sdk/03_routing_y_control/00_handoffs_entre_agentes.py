# Este archivo introduce handoffs entre agentes con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("handoffs entre agentes")

# Resumen final: handoffs entre agentes es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
