# Este archivo introduce agentes como tools con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("agentes como tools")

# Resumen final: agentes como tools es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
