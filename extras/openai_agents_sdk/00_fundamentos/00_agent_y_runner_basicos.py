# Este archivo introduce Agent y Runner basicos con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("Agent y Runner basicos")

# Resumen final: Agent y Runner basicos es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
