# Este archivo introduce instrucciones del agente con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("instrucciones del agente")

# Resumen final: instrucciones del agente es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
