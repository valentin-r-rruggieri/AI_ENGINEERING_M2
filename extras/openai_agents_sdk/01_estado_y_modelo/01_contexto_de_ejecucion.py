# Este archivo introduce contexto de ejecucion con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("contexto de ejecucion")

# Resumen final: contexto de ejecucion es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
