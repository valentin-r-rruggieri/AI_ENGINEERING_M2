# Este archivo introduce seleccion de modelo con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("seleccion de modelo")

# Resumen final: seleccion de modelo es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
