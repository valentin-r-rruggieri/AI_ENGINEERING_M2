# Este archivo introduce file search para RAG con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("file search para RAG")

# Resumen final: file search para RAG es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
