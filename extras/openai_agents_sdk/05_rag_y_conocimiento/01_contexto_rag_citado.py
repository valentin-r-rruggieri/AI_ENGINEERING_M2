# Este archivo introduce contexto RAG citado con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("contexto RAG citado")

# Resumen final: contexto RAG citado es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
