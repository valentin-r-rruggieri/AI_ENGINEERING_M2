# Este archivo introduce schemas de tools con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("schemas de tools")

# Resumen final: schemas de tools es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
