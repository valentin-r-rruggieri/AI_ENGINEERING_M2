# Este archivo introduce function tools con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("function tools")

# Resumen final: function tools es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
