# Este archivo introduce historial de conversacion con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("historial de conversacion")

# Resumen final: historial de conversacion es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
