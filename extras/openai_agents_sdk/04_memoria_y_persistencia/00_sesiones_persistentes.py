# Este archivo introduce sesiones persistentes con OpenAI Agents SDK. Es un paso corto dentro del curso y permite estudiar
...
run_lesson("sesiones persistentes")

# Resumen final: sesiones persistentes es una pieza concreta de OpenAI Agents SDK que se combina despues con el resto del agente.
